...
(
    vehicle_id integer NOT NULL GENERATED BY DEFAULT AS IDENTITY ( INCREMENT 1 START 1 MINVALUE 1 MAXVALUE 2147483647 CACHE 1 ),
    ...
    CONSTRAINT servicing_pkey PRIMARY KEY (vehicle_id),
    CONSTRAINT "fk_servicing-vehicle_id__vehicle-id" FOREIGN KEY (vehicle_id)
...
(
    ...
    CONSTRAINT servicing_for_one_vehicle UNIQUE (servicing)
        INCLUDE(servicing),
